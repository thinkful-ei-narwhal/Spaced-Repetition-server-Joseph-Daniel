    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'magia', translation: 'magic' },
            { original: 'ciao', translation: 'bye' },
            { original: 'piscina', translation: 'pool' },
            { original: 'piccolo', translation: 'small' },
            { original: 'lago', translation: 'lake' },
            { original: 'chiesa', translation: 'church' },
            { original: 'paese', translation: 'country' },
            { original: 'ponte', translation: 'bridge' },
          ]
        }
        return supertest(app)
          .post('/api/user')
